      ...
      <header>
         ...
         <div id="wrapper">    
            <div id="wrapper-inner">
              <h1 class="h1Anime" id="name-header" >
                <span class="text-wrapper">
                  <span class="letters">Ryan Fennell</span>
              </span>
              </h1>
              <h2 id="subtitle" class="ml13">Web Developer</h2>
            </div>
        </div> 
      </header>
      <main class="container-fluid">
        <section id="about" class="row">
          ...
          <section id="contact" class="row">
                  <div id="contact__content" class="container-fluid">
                      <h3>Contact</h3>
                          ...
                          <div id="mail-status"></div>
                            <form name="contact" id="contactForm" action="">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="subject" placeholder="Let me know the subject of your email." class="form-control" id="subject">
                                  </div>
